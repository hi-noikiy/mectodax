...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt btn btn-tb-primary tbWow fadeIn" data-wow-delay="0.2s"><?php echo '' . $product->single_add_to_cart_text(); ?></button>
