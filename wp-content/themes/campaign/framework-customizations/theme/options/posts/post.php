...
$options = array(
	'main' => array(
		'title'   => esc_html__( 'Post Options', 'campaign' ),
		'type'    => 'box',
		'options' => array(
			...
			'related_switch'                    => array(
				'label'        => esc_html__( 'Show related posts?', 'campaign' ),
				'type'         => 'switch',
				'right-choice' => array(
					'value' => 'yes',
					'label' => esc_html__( 'Yes', 'campaign' )
			...
			'related_subtitle'=> array(
				'label' => esc_html__( 'Related Posts Subtitle', 'campaign' ),
				'type'  => 'text',
				'value' => esc_html__('Related Posts', 'campaign'),
			),	
		),
	),
	'side' => array(
