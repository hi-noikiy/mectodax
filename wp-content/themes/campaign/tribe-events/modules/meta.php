...
if ( !empty($tec_google_map) && $tec_google_map[0] != 'default') {
	$googleMapType = $tec_google_map[0];
}
...
<?php if ( $not_skeleton ) : ?>
	<div class="tribe-events-single-section tribe-events-event-meta primary tribe-clearfix tbWow fadeIn">
<?php endif; ?>
