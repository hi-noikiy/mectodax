...
<div class="col-xs-12 col-sm-6 tribe-events-meta-group-details">
	<h3 class="tribe-events-single-section-title"> <?php esc_html_e( 'Details', 'campaign' ) ?> </h3>
	<dl>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<dt> <?php esc_html_e( 'Date:', 'campaign' ) ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr published dtstart" title="<?php echo esc_attr( $start_ts ) ?>"> <?php echo esc_html( $start_date ) ?> </abbr>
			</dd>
		...
		// Single day events
			...
			<dt> <?php esc_html_e( 'Time:', 'campaign' ) ?> </dt>
		...
		if ( ! empty( $cost ) ):
			?>
			<dt> <?php esc_html_e( 'Cost:', 'campaign' ) ?> </dt>
		...
		<?php echo tribe_meta_event_tags( esc_html__( 'Event Tags:', 'campaign' ), ', ', false ) ?>
